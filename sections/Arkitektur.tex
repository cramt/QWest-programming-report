...
De fuldt optrukket linjer between intraprocess kommunikation, oftest når et runtime af en art henter kode ind fra et andet del af projected, fx QWest.Api dll'en som henter ind QWest.DataAccess dll'en.
Ud over dette er modellen også delt op i 2 dele, "trusted enviroment" og "untrusted enviroment", i vores trusted enviroment kan vi stole på at den forespørgsler vi modtager kommer fra os self og vi behøver ikke tænke på ting som sikkerhed of authentikation, "untrusted enviroment" er hvor bruger input kommer fra og det kan være alt fra SQL injection angreb til helt normalt bruger input.
