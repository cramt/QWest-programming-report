...
\usepackage{xcolor}
\definecolor{ucnblue}{RGB}{33,26,82}% dark blue
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% listings & code Highligts
% https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{listings}
\usepackage{minted}
\addto\captionsdanish{\renewcommand{\listingscaption}{Kodeliste}}
...
\definecolor{ucngrey}{RGB}{238,243,244}% dark blue
...
\makeatletter
\newcommand{\setappendix}{Bilag~\thechapter:~}
